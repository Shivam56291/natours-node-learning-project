...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    var popup = L.popup({
      ...
      className: 'map-popup',
      offset: [0, -10]
    }).setContent("<p><strong>Day ".concat(loc.day, "</strong>: ").concat(loc.description, "</p>"));
  ...
  var observer = new IntersectionObserver(function (entries, observer) {
    entries.forEach(function (entry) {
      if (entry.isIntersecting) {
        ...
        map.setView(currentCenter, currentZoom - 3, {
          animate: false
        });
        setTimeout(function () {
    ...
    threshold: 0.3
  } // trigger when 30% of map is visible
  );
...
var stripe = Stripe('pk_test_51SbBIwEXYPoz40PtUGLiMILAuyK2SX7qGpr7NsAqthLsZ8ciU3f8DSuTonOBX8n6XbQnVdTXQr6Oi8BOnYANnP2P00FBU8wsnC');
